 ...
 * 2019-06-06T17:24:26.236+03:00
 * Generated source version: 3.2.7
 *
 */
@WebServiceClient(name = "UserEndpointService",
                  wsdlLocation = "http://localhost:8080/services/userEndpoint?wsdl",
                  targetNamespace = "http://endpoint.soap.burmistrov.ru/")
@Component
public class UserEndpointService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://endpoint.soap.burmistrov.ru/", "UserEndpointService");
    public final static QName UserEndpointPort = new QName("http://endpoint.soap.burmistrov.ru/", "UserEndpointPort");
    static {
        URL url = null;
        try {
